...
public class LowLandMakerScript : MonoBehaviour
{
    ...
    void GrowLowland()
    {
        if (y + 1 < gameBoundary - 1) // space above is not out of bounds 
        {
            ...
            if (Random.Range(0, 100) < G.lowlandMakerChance 
                ...
                & S.Up2(x,y) == MapArrayScript.Blocktype.Land
                & M.blockType[Left, Up2] == MapArrayScript.Blocktype.Land
                & M.blockType[Left2, Up2] == MapArrayScript.Blocktype.Land
                & M.blockType[Right, Up2] == MapArrayScript.Blocktype.Land
            ...
            {
                S.CreateBlockUp(MapArrayScript.Blocktype.Lowland, LowlandMaker, x, y, ElevationSettings.lowlandElevation, S.SpawnedFrom(x, y));
            }
        }
        ...
        if (y - 1 > 0)
        {
            ...
            if (Random.Range(0, 100) < G.lowlandMakerChance
                ...
                & S.Down2(x,y) == MapArrayScript.Blocktype.Land
                & M.blockType[Right, Down2] == MapArrayScript.Blocktype.Land
                & M.blockType[Right2, Down2] == MapArrayScript.Blocktype.Land
                & M.blockType[Left, Down2] == MapArrayScript.Blocktype.Land
                & M.blockType[Left2, Down2] == MapArrayScript.Blocktype.Land
                /*& M.blockType[Left, yPosition] == MapArrayScript.Blocktype.Land
                & M.blockType[Right, yPosition] == MapArrayScript.Blocktype.Land*/)
            {
                S.CreateBlockDown(MapArrayScript.Blocktype.Lowland, LowlandMaker, x, y, ElevationSettings.lowlandElevation, S.SpawnedFrom(x, y));
            }
        }
        ...
        if (x - 1 > 0)
        {
            ...
            if (Random.Range(0, 100) < G.lowlandMakerChance
                ...
                //& M.blockType[Left, Up] == MapArrayScript.Blocktype.Land
                //& M.blockType[Left, Down] == MapArrayScript.Blocktype.Land
                & S.Left2(x,y) == MapArrayScript.Blocktype.Land
                & M.blockType[Left2, Down] == MapArrayScript.Blocktype.Land
                //& M.blockType[Left2, Down2] == MapArrayScript.Blocktype.Land
                & M.blockType[Left2, Up] == MapArrayScript.Blocktype.Land
                //& M.blockType[Left2, Up2] == MapArrayScript.Blocktype.Land
                /*& M.blockType[xPosition, Up] == MapArrayScript.Blocktype.Land
                & M.blockType[xPosition, Down] == MapArrayScript.Blocktype.Land*/)
            {
                S.CreateBlockLeft(MapArrayScript.Blocktype.Lowland, LowlandMaker, x, y, ElevationSettings.lowlandElevation, S.SpawnedFrom(x, y));
            }
        }
        ...
        if (x + 1 < gameBoundary - 1)
        {
            ...
            if (Random.Range(0, 100) < G.lowlandMakerChance
                ...
                //& M.blockType[Right, Up] == MapArrayScript.Blocktype.Land
                //& M.blockType[Right, Down] == MapArrayScript.Blocktype.Land
                & S.Right2(x,y) == MapArrayScript.Blocktype.Land
                & M.blockType[Right2, Down] == MapArrayScript.Blocktype.Land
                //& M.blockType[Right2, Down2] == MapArrayScript.Blocktype.Land
                & M.blockType[Right2, Up] == MapArrayScript.Blocktype.Land
                //& M.blockType[Right2, Up2] == MapArrayScript.Blocktype.Land
                /*& M.blockType[xPosition, Up] == MapArrayScript.Blocktype.Land
                & M.blockType[xPosition, Down] == MapArrayScript.Blocktype.Land*/)
            {
                S.CreateBlockRight(MapArrayScript.Blocktype.Lowland, LowlandMaker, x, y, ElevationSettings.lowlandElevation, S.SpawnedFrom(x, y));
            }
        }
