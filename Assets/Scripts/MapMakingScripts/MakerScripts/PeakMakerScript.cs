...
public class PeakMakerScript : MonoBehaviour
{
    MapArrayScript M;
    ...
    void GrowMountain()
    {
        ...
        {
            if ((S.Up(x,y) == MapArrayScript.Blocktype.Land
        ...
        if (y - 1 > 0)
        {
            if ((S.Down(x,y) == MapArrayScript.Blocktype.Land
        ...
        if (x - 1 > 0)
        {
            if ((S.Left(x,y) == MapArrayScript.Blocktype.Land
        ...
        {
            if( (S.Right(x, y) == MapArrayScript.Blocktype.Land
