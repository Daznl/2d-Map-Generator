...
public class BonusWoodMakerScript : MonoBehaviour
{
    MapArrayScript M;
    ...
    {
        int chance;
        if (M.resourceArray[forrestX, forrestY, 1] == true)
        {
            chance = -1;
        }
        else
    ...
    void GrowForest()
    {
        if (y + 1 < gameBoundary - 1)
        {
            ...
            {
                Instantiate(BonusWoodMaker, new Vector3(x, S.Up(y), elevation), Quaternion.identity);
                M.resourceArray[x, S.Up(y), 1] = true;
                ...
                M.world.worldResources.bonusWood.Add(forestCoordinate);
            }
        }
        ...
        if (y - 1 > 0)
        {
            ...
            {
                Instantiate(BonusWoodMaker, new Vector3(x, S.Down(y), elevation), Quaternion.identity);
                M.resourceArray[x, S.Down(y), 1] = true;
        ...
        if (x - 1 > 0)
        {
            ...
            {
                Instantiate(BonusWoodMaker, new Vector3(S.Left(x), y, elevation), Quaternion.identity);
                M.resourceArray[S.Left(x), y, 1] = true;
        ...
        if (x + 1 < gameBoundary - 1)
        {
            ...
            {
                Instantiate(BonusWoodMaker, new Vector3(S.Right(x), y, elevation), Quaternion.identity);
                M.resourceArray[S.Right(x), y, 1] = true;
